...
The platform combines **React**, **Spring Boot**, **MongoDB**, and **Gemini AI** to deliver an intelligent and interactive learning experience.
...
```bash
git clone https://github.com/sravya132/skillgap-ai.git
cd skillgap-ai
```
